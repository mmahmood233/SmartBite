/**
 * Create Romansia - Traditional Bahraini Rice Restaurant
...
const RESTAURANT_NAME = 'Romansia';
const RESTAURANT_EMAIL = 'romansia@wajba.bh';
...
const RESTAURANT_PHONE = '+973 1733 5566';
  ...
  try {
    ...
    if (existingUser) {
      ...
      const { data: authData, error: authError } = await supabase.auth.admin.createUser({
        email: RESTAURANT_EMAIL, password: '1234.578', email_confirm: true,
