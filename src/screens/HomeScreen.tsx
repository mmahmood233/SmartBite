...
const aiPicks = [
  { id: '1', name: 'Al Qariah', match: 'Match: 92%', image: require('../../assets/food.png') },
  { id: '2', name: 'Shawarma House', match: 'Match: 88%', image: require('../../assets/food.png') },
  { id: '3', name: 'Manousheh Spot', match: 'Match: 86%', image: require('../../assets/wajba_logo.png') },
];
    ...
    <View style={styles.screen}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.moodBanner}>
          ...
          >
            <Text style={styles.moodButtonText}>Open Mood Picker</Text>
          </LinearGradient>
        </View>
...
const styles = StyleSheet.create({
  ...
  locationChip: { alignSelf: 'flex-start', marginTop: 6, backgroundColor: '#E6F3F1', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4, shadowColor: colors.primary, shadowOpacity: 0.15, shadowRadius: 3, shadowOffset: { width: 0, height: 1 }, elevation: 2, borderWidth: 0.5, borderColor: 'rgba(20, 119, 111, 0.2)' },
  locationText: { fontSize: 14, color: colors.primary },
  avatar: { width: 42, height: 42, borderRadius: 21, marginLeft: 8, marginRight: 8, borderColor: colors.primary, borderWidth: 2 },
  ...
  aiCard: { width: 200, height: 240, borderRadius: 16, backgroundColor: '#FFFFFF', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 8, shadowOffset: { width: 0, height: 2 }, marginVertical: 12, overflow: 'hidden' },
  imageContainer: { position: 'relative', width: 200, height: 140 },
  aiImage: { width: 200, height: 140, borderTopLeftRadius: 16, borderTopRightRadius: 16 },
