/**
 * Create Daag Ayoosh - Traditional Bahraini Rice Restaurant
...
const RESTAURANT_NAME = 'Daag Ayoosh';
const RESTAURANT_EMAIL = 'daagayoosh@wajba.bh';
  ...
  try {
    ...
    if (existingUser) {
      ...
      const { data: authData, error: authError } = await supabase.auth.admin.createUser({
        email: RESTAURANT_EMAIL, password: '1234.778', email_confirm: true,
